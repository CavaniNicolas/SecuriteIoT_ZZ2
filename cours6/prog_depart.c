...
#define MQTT_CLIENTID (char*)"GROUPE_12"
...
// Topic Names
String subLED  = "/ISIMA/S6_AES/GROUPE_12/LEDS/#";
String subBP   = "/ISIMA/S6_AES/GROUPE_12/PS/#";
String pubBP1  = "/ISIMA/S6_AES/GROUPE_12/BPS/BP1";
String pubBP2  = "/ISIMA/S6_AES/GROUPE_12/BPS/BP2";
String pubLED1 = "/ISIMA/S6_AES/GROUPE_12/LEDS/LED1";
String pubLED2 = "/ISIMA/S6_AES/GROUPE_12/LEDS/LED2";
...
void AESSetup()
{
 // TODO : Initialisation of AES Cipher
}

char * encode64(char * input, int inputLen) {
  // encoding base64
  // int inputLen = sizeof(input);
  
  int encodedLen = base64_enc_len(inputLen) + 1; // +1 important pour le '\0'
  ...
  // return encoded; ERREUR, encoded est une variable locale
  // String encodedR = encoded;
  return encoded;
}

String decode64(String plainStr) {
...
String AESEncrypt(String plainStr)
{
 ...
 String saltedPlain64 = encode64(StringToChar(saltedPlain), saltedPlain.length()); 
  ...
  Serial.print(   "   Salted message base64                : "); Serial.println(saltedPlain64);
  Serial.println( "");  
 #endif
