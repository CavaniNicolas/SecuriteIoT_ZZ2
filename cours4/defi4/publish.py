...
try:
	client.username_pw_set(username="ANTITAU", password="GHY7856L")
	client.connect("172.16.32.8", 10804)
...
while True:
	(rc, mid) = client.publish(topic="/ISIMA/SECRET_ISIBONGO/CHALLENGE_1/DEFI_4/GROUPE_CAVANI/LEDS/LED2", payload="ON", qos=0)
